                    ...
                    <form action="{{ url('admin/blogs/create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="blog_title" rows="3" class="form-control"></textarea>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="blog_heading_1" rows="3" class="form-control"></textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Second Heading</label>
                                <textarea name="blog_heading_2" rows="3" class="form-control"></textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Blog Post Text #1</label>
                                <textarea name="blog_post_text_1" rows="3" class="form-control"></textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Blog Post Text #2</label>
                                <textarea name="blog_post_text_2" rows="3" class="form-control"></textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Blog Post Text #3</label>
                                <textarea name="blog_post_text_3" rows="3" class="form-control"></textarea>
                            </div>
