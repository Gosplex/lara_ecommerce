                        ...
                        <div class="position-relative overflow-hidden" style="height: 250px">
                            ...
                            <div class="overlay">
                                ...
                                <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold"
                                    href="">{{ $latestPost->blog_title }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 px-0">
                        <div class="position-relative overflow-hidden" style="height: 250px">
                            <img class="img-fluid w-100 h-100" src="{{ asset("$latestPost1->headline_image") }}" style="object-fit: cover" />
                            <div class="overlay">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                ...
                                <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold"
                                    href="">{{ $latestPost1->blog_title }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 px-0">
                        <div class="position-relative overflow-hidden" style="height: 250px">
                            <img class="img-fluid w-100 h-100" src="{{ asset("$latestPost2->headline_image") }}" style="object-fit: cover" />
                            <div class="overlay">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                ...
                                <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold"
                                    href="">{{ $latestPost2->blog_title }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 px-0">
                        <div class="position-relative overflow-hidden" style="height: 250px">
                            <img class="img-fluid w-100 h-100" src="{{ asset("$latestPost3->headline_image") }}" style="object-fit: cover" />
                            <div class="overlay">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                        ...
                        <div class="owl-carousel tranding-carousel position-relative d-inline-flex align-items-center ml-3"
                            ...
                            <div class="text-truncate">
                                <a class="text-white text-uppercase font-weight-semi-bold" href="">Lorem ipsum
                                    dolor sit amet elit. Proin interdum lacus eget
                ...
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-lg-12 mb-3">
                            <a href=""><img class="img-fluid w-100" src="img/ads-728x90.png"
                                    alt="" /></a>
                        </div>
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
