    ...
    <div class="bg-light">
        <div class="container py-5">
            <div class="row h-100 align-items-center py-5">
                <div class="col-lg-6">
                    <h1 class="display-4">About Majestic Stores</h1>
                    <p class="lead text-muted mb-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet, corporis?
                    </p>
                    <p class="lead text-muted">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt ex et, aliquid dolore distinctio
                        magnam veniam ea ipsa voluptas. Deserunt accusamus ab praesentium aspernatur ipsa officia, incidunt
                        quasi amet? Vel voluptates alias voluptatibus eius exercitationem officia consequatur ratione
                        quaerat nisi?
                    </p>
                </div>
