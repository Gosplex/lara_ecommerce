                        ...
                        <div class="col-md-6 border-right">
                            <div class="p-3 py-5">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <a href="{{url('change-password')}}" class="btn btn-primary text-white float-end">Change Password</a>
                                </div>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12"><label class="labels">Mobile Number</label>
                                        <input type="text" class="form-control form-design"
                                            placeholder="Enter Phone Number" value="{{ Auth::user()->userDetail->phone }} ?? '' "
                                            name="phone">
                                    </div>
