            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="mt-1">Edit Blog Post
                        <a href="{{ url('blogs/view') }}" class="btn btn-danger btn-sm float-end text-white">
                            BACK
                        </a>
                        </h4>
                </div>
                    ...
                    <form action="{{ url('admin/blogs/') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="author_name" value="{{ $blogposts->author_name }}"
                                    class="form-control">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>First Heading</label>
                                <textarea name="blog_heading_1" rows="3" class="form-control">{{ $blogposts->blog_heading_1 }}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Second Heading</label>
                                <textarea name="blog_heading_2" rows="3" class="form-control">{{ $blogposts->blog_heading_2 }}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Blog Post Text #1</label>
                                <textarea name="blog_post_text_1" rows="3" class="form-control">{{ $blogposts->blog_post_text_1 }}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Blog Post Text #2</label>
                                <textarea name="blog_post_text_2" rows="3" class="form-control">{{ $blogposts->blog_post_text_2 }}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label>Blog Post Text #3</label>
                                <textarea name="blog_post_text_3" rows="3" class="form-control">{{ $blogposts->blog_post_text_3 }}</textarea>
                            </div>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="checkbox" name="featured_news">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Latest News</label>
                                <input type="checkbox" name="latest_news">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Trending News</label>
                                <input type="checkbox" name="trending_news">
                            </div>
                            <div class="col-md-2 mb-3">
                                <label>Status</label>
